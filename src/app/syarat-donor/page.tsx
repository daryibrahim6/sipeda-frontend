...
import { FAQ_LIST, type FAQItem } from '@/lib/faq-data';
  ...
  return (
    <div className="space-y-8">
      {Object.entries(grouped).map(([kategori, faqs]) => (
        <div key={kategori}>
          <h3 className="font-bold text-[var(--color-text-primary)] mb-3 text-lg">
          ...
          <div className="space-y-2">
            {faqs.map(faq => (
              <details
                key={faq.id}
                className="group bg-white border border-[var(--color-border-muted)] rounded-xl overflow-hidden"
              >
                <summary className="flex items-center justify-between gap-3 px-5 py-4 cursor-pointer list-none hover:bg-[var(--color-section-alt)] active:bg-[var(--color-primary-subtle)] transition-colors">
                  <span className="font-medium text-[var(--color-text-primary)] text-sm leading-relaxed">
                    {faq.pertanyaan}
                  </span>
                  <ChevronDown className="w-4 h-4 text-[var(--color-text-muted)] flex-shrink-0 group-open:rotate-180 transition-transform" />
                </summary>
                <div className="px-5 pb-4 text-sm text-[var(--color-text-secondary)] leading-relaxed border-t border-gray-50 pt-3">
                  {faq.jawaban}
                </div>
              </details>
            ))}
...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default function SyaratDonorPage() {
  const faqItems = FAQ_LIST;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h2 className="text-2xl font-bold text-[var(--color-text-primary)]">Syarat Boleh Donor</h2>
                </div>
                <div className="space-y-2">
                  {SYARAT_UMUM.map((s, i) => (
                    <div key={i} className="flex items-start gap-3 p-3 rounded-xl hover:bg-[var(--color-section-alt)] active:bg-gray-100 transition-colors">
              ...
              <section>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h2 className="text-2xl font-bold text-[var(--color-text-primary)]">Tidak Boleh Donor</h2>
                </div>
                <div className="space-y-2">
              ...
              <section>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h2 className="text-2xl font-bold text-[var(--color-text-primary)]">Persiapan Sebelum Donor</h2>
                </div>
              ...
              <section>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h2 className="text-2xl font-bold text-[var(--color-text-primary)]">Proses Donor Darah</h2>
                </div>
                  ...
                  <div className="space-y-4">
                    {PROSES_DONOR.map((p, i) => (
                      <div key={i} className="flex gap-5">
                        ...
                        <div className="flex-1 bg-white border border-[var(--color-border-muted)] rounded-2xl p-5 shadow-[var(--shadow-card)]">
                          <div className="flex items-start justify-between gap-3 mb-1">
                            <h3 className="font-bold text-[var(--color-text-primary)]">{p.title}</h3>
              ...
              {faqItems.length > 0 && (
                <section>
                  <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-6">Pertanyaan Umum (FAQ)</h2>
            ...
            <div className="space-y-5 sticky top-24 self-start">
              ...
              <div className="bg-red-600 text-white rounded-2xl p-6">
                ...
                <Link href="/jadwal"
                  className="block text-center py-3 bg-white text-red-700 font-bold rounded-xl hover:bg-red-50 active:scale-[0.97] transition-all text-sm">
                  Lihat Jadwal Donor
                </Link>
              </div>

              {/* Kontak PMI */}
              <div className="bg-white border border-[var(--color-border-muted)] rounded-2xl p-6 shadow-[var(--shadow-card)]">
                <h3 className="font-bold text-[var(--color-text-primary)] mb-3">Kontak PMI Indramayu</h3>
                <div className="space-y-2 text-sm">
                  <div className="text-[var(--color-text-secondary)]">
                    📞 <a href="tel:+628119198611" className="text-[var(--color-primary)] font-medium hover:underline">0811-919-8611</a>
                  </div>
                  <div className="text-[var(--color-text-secondary)]">
